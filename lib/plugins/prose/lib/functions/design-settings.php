...
function prose_get_fresh_design_option( $opt ) {
	$setting = get_option( MACHINA_DESIGN_SETTINGS_FIELD );
 ...
 * @author Machina Themes
 * @return mixed
 * @uses machina_get_option()
 */
function prose_get_design_option( $opt ) {
	return machina_get_option( $opt, MACHINA_DESIGN_SETTINGS_FIELD );
}
...
function prose_add_select_setting( $id, $label, $type ) {
	return prose_add_label( $id, $label ) . '<select id="' . $id . '" name="' . MACHINA_DESIGN_SETTINGS_FIELD . '[' . $id . ']" class="' . $type . '-option-types">' . prose_create_options( prose_get_fresh_design_option( $id ), $type ) . '</select>';
}
...
function prose_add_color_setting( $id, $label ) {
	return prose_add_label( $id, $label ) . '<input type="text" id="' . $id . '" name="' . MACHINA_DESIGN_SETTINGS_FIELD . '[' . $id . ']" size="8" maxsize="7" value="' . esc_attr( prose_get_fresh_design_option( $id ) ) . '" class="color-picker" />';
}
...
function prose_add_background_color_setting( $id, $label ) {
	return prose_add_select_setting( $id.'_select', $label, 'background' ) . '<input type="text" id="' . $id . '_hex" name="' . MACHINA_DESIGN_SETTINGS_FIELD . '[' . $id . ']" size="8" maxsize="7" value="' . esc_attr( prose_get_fresh_design_option( $id ) ) . '" class="color-picker" />';
}
...
function prose_add_size_setting( $id, $label, $size = 1 ) {
	return prose_add_label( $id, $label, false ) . '<input class="numeric" type="text" id="' . $id . '" name="' . MACHINA_DESIGN_SETTINGS_FIELD . '[' . $id . ']" size="' . $size . '" value="' . esc_attr( prose_get_fresh_design_option( $id ) ) . '" /><abbr title="pixels">px</abbr></label>';
}
...
function prose_add_em_size_setting( $id, $label, $size = 3 ) {
	return prose_add_label( $id, $label, false ) . '<input class="numeric" type="text" id="' . $id . '" name="' . MACHINA_DESIGN_SETTINGS_FIELD . '[' . $id . ']" size="' . $size . '" value="' . esc_attr( prose_get_fresh_design_option( $id ) ) . '" /></label>';
}
...
function prose_add_text_setting( $id, $label, $size = 25 ) {
	return prose_add_label( $id, $label ) . '<input type="text" id="' . $id . '" name="' . MACHINA_DESIGN_SETTINGS_FIELD . '[' . $id . ']" size="' . $size . '" value="' . esc_attr( prose_get_fresh_design_option( $id ) ) . '" />';
}
...
function prose_add_checkbox_setting( $id, $label ) {
	return '<input type="checkbox" id="' . $id . '" name="' . MACHINA_DESIGN_SETTINGS_FIELD . '[' . $id . ']" value="true" class="checkbox" ' . checked(prose_get_fresh_design_option( $id ), 'true', false) . '/> ' . prose_add_label( $id, $label, true, false );
}
...
function prose_add_textarea_setting( $id, $label, $cols = 25, $rows = 10 ) {
	return prose_add_label( $id, $label ) . '<br /><textarea id="' . $id . '" name="' . MACHINA_DESIGN_SETTINGS_FIELD . '[' . $id . ']" cols="39" rows="10">' . prose_get_fresh_design_option( $id ) . '</textarea>';
}
