 ...
 * @link       http://machinathemes.de/en/wp-plugins/machina-widgetized-notfound/
 *
 * @since      1.5.0
 */
...
function ddw_gwnf_bbpress_widgetized_noresults_area() {
	...
	$gwnf_bbpress_noresults_widget_title = apply_filters(
		...
		__( 'bbPress: Forum Search No Results', 'machina-widgetized-notfound' )
	);

	$gwnf_bbpress_noresults_widget_description = apply_filters(
		'gwnf_filter_bbpress_noresults_widget_title',
		__( 'Only for bbPress 2.3+: Widgetized content area if there are no forum search results.', 'machina-widgetized-notfound' )
	);
