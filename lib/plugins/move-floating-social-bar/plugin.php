<?php
/**
 * Move Floating Social Bar in Machina
 *
 * @package   Move_Floating_Social_Bar_In_Machina
 * @author    Machina Themes <machina@machinathemes.com>
 * @license   GPL-2.0+
 * @link      https://github.com/Machina
 * @copyright 2013 Machina Themes
 *
 * @wordpress-plugin
 * Plugin Name:       Move Floating Social Bar in Machina
 ...
 * Author URI:        http://machina.com/
 * Text Domain:       move-floating-social-bar-in-machina
 * License:           GPL-2.0+
 ...
 * content (after the header and entry meta) in Machina child themes.
 *
