 ...
 * @package Machina_Single_Breadcrumbs
 */
class Machina_Single_Breadcrumbs {
	 ...
	 * @var      string
	 */
	const PLUGIN_SLUG = 'machina-single-breadcrumbs';
	...
	private static function single_activate() {
		if ( 'machina' != basename( TEMPLATEPATH ) ) {
                deactivate_plugins( plugin_basename( __FILE__ ) );
                wp_die( sprintf( __( 'Sorry, you can&rsquo;t activate this plugin unless you have a child theme of the <a href="%s">Machina Framework</a> active.', 'machina-single-breadcrumbs'), 'http://machina-theme-framework.com/' ) );
        }
	}
