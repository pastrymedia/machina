...
/**
 * Machina Featured Page widget class.
 *
 * @since 0.1.8
 *
 * @package Machina\Widgets
 */
class Machina_Featured_Page extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays featured page with thumbnails', 'machina' ),
		);
		...
		parent::__construct( 'featured-page', __( 'Machina - Featured Page', 'machina' ), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php _e( 'Page', 'machina' ); ?>:</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Show Page Title', 'machina' ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_content' ); ?>"><?php _e( 'Show Page Content', 'machina' ); ?></label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'content_limit' ); ?>"><?php _e( 'Content Character Limit', 'machina' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'more_text' ); ?>"><?php _e( 'More Text', 'machina' ); ?>:</label>
