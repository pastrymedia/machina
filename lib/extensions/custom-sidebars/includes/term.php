...
?>
	...
	<tr class="form-field">
		<th scope="row" valign="top"><label for="machina-meta[_ss_sidebar]"><?php _e( 'Primary Sidebar', 'ss' ); ?></label></th>
		<td>
			<select name="machina-meta[_ss_sidebar]" id="machina-meta[_ss_sidebar]" style="padding-right: 10px;">
...
?>
	<tr class="form-field">
		<th scope="row" valign="top"><label for="machina-meta[_ss_sidebar_alt]"><?php _e( 'Secondary Sidebar', 'ss' ); ?></label></th>
		<td>
			<select name="machina-meta[_ss_sidebar_alt]" id="machina-meta[_ss_sidebar_alt]" style="padding-right: 10px;">
				<option value=""><?php _e( 'Default', 'ss' ); ?></option>
				<?php
				foreach ( (array) $_sidebars as $id => $info ) {
