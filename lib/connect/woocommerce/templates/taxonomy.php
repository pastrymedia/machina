...
add_action( 'machina_loop', 'machinawooc_product_taxonomy_loop' );
/**
 ...
 * @uses machinawooc_product_taxonomy() for earlier WooC versions
 *
 * @since 0.9.0
 * @updated 0.9.4
 */
function machinawooc_product_taxonomy_loop() {
