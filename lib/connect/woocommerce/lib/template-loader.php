...
/**
 * Load the Machina-fied templates, instead of the WooCommerce defaults.
 *
 ...
 */
function machinawooc_product_archive() {
 ...
 * @since 0.9.4
 */
function machinawooc_product_taxonomy() {
 ...
 * @since 0.9.4
 */
function machinawooc_content_product() {
