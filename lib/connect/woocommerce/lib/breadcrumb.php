<?php
/**
 * This file contains functions related modifying Machina Breadcrumb output
 *
 ...
 *
 *
 * By default, the Machina Breadcrumb class does not handle Shop pages and taxonomy
 * archives in the same way as WooC's breadcrumbs. These filters and callback
 * functions modify the default Machina breadcrumb output so that the breadcrumb
 ...
 *
 * As this modification code uses existing Machina Breadcrumb filters there is a risk that
 * it will cause compatibility issues with any existing uses of Machina Breadcrumb filters.
 ...
 *
 * @see machina/lib/classes/breadcrumb.php v1.8
 * @see woocommerce/templates/shop/breadcrumb.php v1.4.4
 *
 * @TODO Replace with subclass of Machina_Breadcrumb?
 */
...
add_filter( 'machina_archive_crumb', 'gencwooc_get_archive_crumb_filter', 10, 2 );
/**
 * Filter the Machina Breadcrumbs archive crumb
 *
 ...
 * @param array $args Machina Breadcrumb args
...
add_filter( 'machina_single_crumb', 'gencwooc_get_single_crumb', 10, 2 );
/**
 * Filter the Machina Breadcrumbs singular crumb
 *
 ...
 *
 * This is a copy of Machina_Breadcrumb::get_breadcrumb_link() (G1.8)
 *
 * @since 0.9.0
 *
