 ...
 * @package Machina\Sanitizer
 */
class Machina_Settings_Sanitizer {
	 ...
	 * @since 1.7.0
	 *
	 * @var Machina_Settings_Sanitizer
	 */
	static $instance;
	...
	function __construct() {
		...
		do_action_ref_array( 'machina_settings_sanitizer_init', array( &$this ) );
	 ...
	 *
	 * Array can be filtered via 'machina_available_sanitizer_filters' to let
	...
	function get_available_filters() {
		...
		return apply_filters( 'machina_available_sanitizer_filters', $default_filters );
 ...
 *
 * Use the 'machina_settings_sanitizer_init' action to be notified when this function is safe to use
 *
 * @since 1.7.0
 *
 * @uses Machina_Settings_Sanitizer::add_filter()
 *
 * @param string $filter The filter to call (see Machina_Settings_Sanitizer::$available_filters for options)
 ...
 * @return true
 */
function machina_add_option_filter( $filter, $option, $suboption = null ) {

	return Machina_Settings_Sanitizer::$instance->add_filter( $filter, $option, $suboption );

}

add_action( 'admin_init', 'machina_settings_sanitizer_init' );
/**
 * Instantiate the Sanitizer.
 *
 * @since 1.7.0
 */
function machina_settings_sanitizer_init() {

	new Machina_Settings_Sanitizer;
