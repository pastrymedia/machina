 ...
 * Snippets file.
 *
 * Contains the most popular Machina snippets used.
 *
 * @category   Machina_Sandbox
 * @package    Functions
 * @subpackage Snippets
...
/* Table of Contents
   ...
   01 Layout
   02 Favicon
   03 Remove Machina in-post metaboxes
   04 Remove Machina Admin Menus
   05 Machina Style Selector
...
add_filter( 'machina_site_layout', '__machina_return_content_sidebar' );

// Force Sidebar-Content Layout
add_filter( 'machina_site_layout', '__machina_return_sidebar_content' );

// Force Content-Sidebar-Sidebar Layout
add_filter( 'machina_site_layout', '__machina_return_content_sidebar_sidebar' );

// Force Sidebar-Sidebar-Content Layout
add_filter( 'machina_site_layout', '__machina_return_sidebar_sidebar_content' );

// Force Sidebar-Content-Sidebar Layout
add_filter( 'machina_site_layout', '__machina_return_sidebar_content_sidebar' );
...
// Force Content-Sidebar Layout
add_filter( 'machina_pre_get_option_site_layout', '__machina_return_content_sidebar' );

// Force Sidebar-Content Layout
add_filter( 'machina_pre_get_option_site_layout', '__machina_return_sidebar_content' );

// Force Content-Sidebar-Sidebar Layout
add_filter( 'machina_pre_get_option_site_layout', '__machina_return_content_sidebar_sidebar' );

// Force Sidebar-Sidebar-Content Layout
add_filter( 'machina_pre_get_option_site_layout', '__machina_return_sidebar_sidebar_content' );

// Force Sidebar-Content-Sidebar Layout
add_filter( 'machina_pre_get_option_site_layout', '__machina_return_sidebar_content_sidebar' );
...
/** Remove favicon */
remove_action('machina_meta', 'machina_load_favicon');

add_filter( 'machina_pre_load_favicon', 'gs_pre_load_favicon' );
/**
 * Change favicon
 *
...
/** Remove Machina in-post SEO Settings */
remove_action( 'admin_menu', 'machina_add_inpost_seo_box' );

/** Remove Machina Layout Settings */
remove_theme_support( 'machina-inpost-layouts' );

/*
04 Remove Machina admin menus
---------------------------------------------------------------------------------------------------- */

/** Remove Machina menu link */
remove_theme_support( 'machina-admin-menu' );

/** Remove Machina SEO Settings menu link */
remove_theme_support( 'machina-seo-settings-menu' );

/** Remove README theme support */
remove_theme_support( 'machina-readme-menu' );
...
add_filter( 'machina_author_box_title', 'gs_author_box_title' );
/**
...
add_filter( 'machina_author_box_gravatar_size', 'gs_author_box_gravatar_size', 10, 2 );
/**
...
add_filter( 'machina_author_box', 'gs_author_box', 10, 6 );
/**
...
08 Post Info & Post Meta
---------------------------------------------------------------------------------------------------- */
add_filter( 'machina_post_info', 'gs_post_info_filter' );
/**
...
add_filter ( 'machina_next_link_text' , 'gs_next_link_text' );
/**
 * Customize the next page link
 *
 * @param  string $text Default next page link.
 * (default: __( 'Next Page', 'machina' ) . '&#x000BB;' )
...
add_filter ( 'machina_prev_link_text' , 'gs_prev_link_text' );
/**
 * Customize the previous page link
 *
 * @param  string $text Default previous page link.
 * (default: __( 'Previous Page', 'machina' ) . '&#x000BB;' )
...
add_filter ( 'machina_newer_link_text' , 'gs_newer_link_text' );
/**
 * Customize the newer posts link
 *
 * @param  string $text Default newer posts link.
 * (default: __( 'Newer Posts', 'machina' ) . '&#x000BB;' )
...
add_filter ( 'machina_older_link_text' , 'gs_older_link_text' );
/**
 * Customize the older posts link
 *
 * @param  string $text Default older posts link.
 * (default: __( 'Older Posts', 'machina' ) . '&#x000BB;' )
...
add_filter( 'machina_search_text', 'gs_search_text' );
/**
 * Customize search form input box text
 *
 * @param  string $text Default search form input box text.
 * (default: esc_attr__( 'Search this website', 'machina' ) . '&#x02026;' )
...
add_filter( 'machina_search_button_text', 'gs_search_button_text' );
/**
...
remove_action( 'machina_site_title', 'machina_seo_site_title' );

/** Remove the site description */
remove_action( 'machina_site_description', 'machina_seo_site_description' );
...
add_action( 'machina_after_header', 'machina_do_breadcrumbs' );
...
add_action( 'machina_after', 'machina_footer_markup_open', 11 );
add_action( 'machina_after', 'machina_do_footer', 12 );
add_action( 'machina_after', 'machina_footer_markup_close', 13 );

/** Reposition the primary navigation menu */
remove_action( 'machina_after_header', 'machina_do_nav' );
add_action( 'machina_before_header', 'machina_do_nav' );

/** Reposition the secondary navigation menu */
remove_action( 'machina_after_header', 'machina_do_subnav' );
add_action( 'machina_before_header', 'machina_do_subnav' );
...
/**
 * Remove Machina/WordPress widgets
 */
function gs_remove_enews_updates_widget() {
	// Remove eNews and Updates widget (softly deprecated in Machina 1.9)
	unregister_widget( 'Machina_eNews_Updates' );

	// Remove Latest Tweets widget (softly deprecated in Machina 1.9)
	unregister_widget( 'Machina_Latest_Tweets_Widget' );

	// Remove Featured Page widget
	unregister_widget( 'Machina_Featured_Page' );

	// Remove Featured Post widget
	// Don't do if using Machina Featured Widget Amplified
	unregister_widget( 'Machina_Featured_Post' );

	// Remove User Profile widget
	unregister_widget( 'Machina_User_Profile_Widget' );
...
add_filter( 'machina_options', 'gs_define_machina_settings', 10, 2 );
/**
 * Define Machina Options
 *
 * @param array $options Array of Setting Options.
 * @param string $setting Specific Setting.
 */
function gs_define_machina_settings( $options, $setting ) {
    if ( MACHINA_SETTINGS_FIELD === $setting ) {
...
add_action( 'machina_theme_settings_metaboxes', 'child_remove_metaboxes' );
/**
 * Remove unused theme settings
 *
 * @param string $_machina_theme_settings_pagehook Machina Admin Pagehook.
 */
function child_remove_metaboxes( $_machina_theme_settings_pagehook ) {
	remove_meta_box( 'machina-theme-settings-version', $_machina_theme_settings_pagehook, 'main' );
	remove_meta_box( 'machina-theme-settings-feeds', $_machina_theme_settings_pagehook, 'main' );
	remove_meta_box( 'machina-theme-settings-header', $_machina_theme_settings_pagehook, 'main' );
	remove_meta_box( 'machina-theme-settings-layout', $_machina_theme_settings_pagehook, 'main' );
	remove_meta_box( 'machina-theme-settings-nav', $_machina_theme_settings_pagehook, 'main' );
	remove_meta_box( 'machina-theme-settings-breadcrumb', $_machina_theme_settings_pagehook, 'main' );
	remove_meta_box( 'machina-theme-settings-comments', $_machina_theme_settings_pagehook, 'main' );
	remove_meta_box( 'machina-theme-settings-posts', $_machina_theme_settings_pagehook, 'main' );
...
remove_action( 'machina_doctype', 'machina_do_doctype' );
add_action( 'machina_doctype', 'gs_do_doctype' );
/**
...
//add_filter( 'machina_slider_settings_defaults', 'gs_machina_slider_defaults' );
/**
 * Set Machina Slider Defaults
 *
 * @param array $defaults Original Machina Slider defaults
 * @return array $defaults Modified Machina Slider defaults
 */
function gs_machina_slider_defaults( $defaults ) {
...
function gs_new_avatar( $avatar_defaults ){
	$avatar_defaults[INCIPIO_ADMIN . '/images/machina-48x48.png'] = __( 'New Avatar Name', 'incipio' );
...
function gs_avatar_default() {
	...
	if ( ( empty( $default ) ) || ( 'mystery' == $default ) )
		$default = INCIPIO_ADMIN . '/images/machina-48x48.png';
	update_option( 'avatar_default', $default );
}

//add_action( 'machina_register_sidebar_defaults', 'gs_register_sidebar_defaults' );
/**
 * 02 Customize Machina Sidebar Defaults
 *
 * This function customizes the sidebar defaults. This function must be
 * placed before the initialization of Machina since machina_register_sidebar_defaults
 * is fired in the machina_setup hook. Feel free to completely remove this function.
 *
 * @since 1.1.0
 *
 * @param  array $defaults Machina sidebar defaults
 * @return array Modified Machina sidebar defaults
 */
...
//add_theme_support( 'machina-menus', array( 'primary' => 'Primary Navigation Menu' ) );

/** Remove Machina Menus */
//remove_theme_support( 'machina-menus' );
...
foreach ( array( 'content-sidebar-sidebar', 'sidebar-sidebar-content', 'sidebar-content-sidebar', 'sidebar-content', 'content-sidebar', 'full-width-content', ) as $layout )
	machina_unregister_layout( $layout );
*/
	 ...
	 * 19 Remove Edit link
	 */
	add_filter( 'machina_edit_post_link', '__return_false' );
	...
	foreach ( array( 'machina_user_options_fields', 'machina_user_archive_fields', 'machina_user_seo_fields', 'machina_user_layout_fields', ) as $field ) {
